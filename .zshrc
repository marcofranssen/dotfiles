...
plugins=(macos gh kubectl helm docker terraform golang keychain gpg-agent sigstore zsh-autosuggestions aws direnv fzf nerdctl terraform-docs ansi-colors)
