...
o.listchars = { tab = '» ', trail = '·', nbsp = '␣', lead = '·' } -- Configure how whitespace characters are displayed
...
if vim.fn.getenv("TERM_PROGRAM") == "ghostty" then
  o.title = true -- Set the terminal title to the value of 'titlestring'
  o.titlestring = "%{fnamemodify(getcwd(), ':t')} %t - nvim" -- Set the terminal title to the current directory and file name
end
